      ...
      <Collapse in={openDropdownIndex === 1 ? true : false}>
        <div id="collapseLayouts">
          <nav className="sb-sidenav-menu-nested nav">
            <Link className="nav-link" to="master/aksesuser">
              Akses User
            </Link>
            <Link className="nav-link" to="master/kelurahan">
              Master Kec./Kel.
            </Link>
            <Link className="nav-link" to="master/jabatan">
              Master Jabatan
            </Link>
            <Link className="nav-link" to="master/pegawai">
              Master Pegawai
            </Link>
          </nav>
        </div>
